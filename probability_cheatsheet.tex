...
\begin{description}
    \item[Story] $X$ is the number of "failures" that we will achieve before we achieve our first success. Our successes have probability $p$. \textbf{Memoryless}.
...
\begin{description}
    ...
    \end{itemize} 
    \item[PMF] $P_X(k) = \sfrac{{w \choose k}{b \choose n-k}}{{w + b \choose n}} \quad k \in \{0, 1, 2, \dots,  n\}$
...
\textbf{Distribution} & \textbf{PMF/PDF and Support} & \textbf{E[X]}  & \textbf{Var[X]} & \textbf{MGF}\\
\hline 
